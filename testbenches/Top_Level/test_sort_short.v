...
// MAIN: 	// JL ITR_ARR			; Iterate through unsorted array
...
module test_sort_short;

parameter RegAddrBits = 3;
parameter DataWidth = 16;
parameter TotalReg = 8;
parameter TestFile = "../../testbenches/Test_Programs/test_sort_short.txt";
parameter DataFile = "../../testbenches/Test_Programs/test_sort_short_data.txt";
...
begin
	...
	#10 RST = 0;
	#2800 $monitor ("%t, %x, %x,", $time, inr, out_value);
